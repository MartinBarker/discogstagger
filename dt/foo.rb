...
#evaluates an artistID, gets members, each members groups/name/namevariations
...
require 'discogs-wrapper'
wrapper = Discogs::Wrapper.new("shop")
release = wrapper.get_release("5298910") #ash
#release = wrapper.get_release("3092597") #wendy&bonnie
#release = wrapper.get_release('10553090') # two artists
#release = wrapper.get_release("8643853") #japanese
#release = wrapper.get_release("6672384") #garage
#release = wrapper.get_release("9121248") #companies/credits/notes/barcodes
